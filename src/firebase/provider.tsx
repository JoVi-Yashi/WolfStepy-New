...
export const useFirestore = (): Firestore => {
  ...
  if (!areServicesAvailable || !firestore) {
    throw new Error('Firebase Firestore service is not available. Check FirebaseProvider setup.');
  }
  return firestore;
};
...
export const useFirebaseApp = (): FirebaseApp => {
  ...
  if (!areServicesAvailable || !firebaseApp) {
    throw new Error('Firebase App instance is not available. Check FirebaseProvider setup.');
  }
  return firebaseApp;
};
...
export const useStorage = (): Storage => {
    const { storage, areServicesAvailable } = useFirebase();
    if (!areServicesAvailable || !storage) {
        throw new Error('Firebase Storage service is not available. Check FirebaseProvider setup.');
    }
    return storage;
};
